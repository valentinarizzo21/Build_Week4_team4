...
('Rum Ron Diplomatico', 42.00, 'Rum venezuelano premium, ricco di note di vaniglia e frutta secca, ideale per cocktail o da degustare puro.', 4, 'Diplomatico', 10, 3, 'https://www.scamuzzivini.it/wp-content/uploads/2016/10/2239-hendricks-gin.jpg', 3),
('Tequila Patron Silver', 50.00, 'Tequila messicana premium, dal gusto fresco e pulito, perfetta per margarita o da bere liscio.', 6, 'Patron', 0, 7, 'https://www.piacenzadabere.it/wp-content/uploads/2020/04/diplomatico-1024x1024.jpg', 4),
('Vodka Belvedere', 38.00, 'Vodka polacca di alta qualità, dal gusto liscio e setoso, ideale per cocktail sofisticati.', 10, 'Belvedere', 0, 3, 'https://www.marcobacco.it/wp-content/uploads/2020/07/patron_silver_tequila_messico.jpg', 5),
('Whiskey Jameson', 22.00, 'Whiskey irlandese morbido con un profilo di frutta secca e vaniglia, perfetto per un Irish Coffee.', 12, 'Jameson', 5, 3, 'https://s.tannico.it/media/catalog/product/cache/1/thumbnail/0dc2d03fe217f8c83829496872af24a0/b/e/belv1.jpg', 6),
('Amaretto Disaronno', 25.00, 'Liquore dolce italiano con aroma di mandorla, perfetto per cocktail o da sorseggiare da solo.', 15, 'Disaronno', 10, 3, 'https://m.media-amazon.com/images/I/61UziizAALL.jpg', 4),
('Vermouth Martini Rosso', 14.00, 'Vermouth rosso italiano, con un profilo aromatico di erbe, spezie e agrumi, ideale per un Negroni.', 20, 'Martini', 5, 3, 'https://shop.rivoldrink.it/wp-content/uploads/2023/04/Disaronno_v2.jpg', 4),
('Limoncello di Capri', 18.00, 'Liquore italiano a base di limoni di Capri, fresco e aromatico, perfetto come digestivo.', 8, 'Limoncello di Capri', 0, 3, 'https://www.kalsa.store/wp-content/uploads/LQ0233.jpg', 4),
('Cointreau', 28.00, 'Liquore francese all’arancia, ideale per cocktails come Cosmopolitan o Margarita.', 19, 'Cointreau', 10, 3, 'https://www.valentinienoteca.it/272249-large_default/limoncello-di-capri-100cl-32-vol.jpg', 4),
('Bourbon Woodford Reserve', 55.00, 'Bourbon americano di alta classe, dal gusto ricco e morbido con note di vaniglia e caramello.', 14, 'Woodford Reserve', 15, 5, 'https://www.carrefour.it/on/demandware.static/-/Sites-carrefour-master-catalog-IT/default/dwb27f44a8/large/COINTREAUGR40-3035542004206-1.png', 6),
('Gin Mare', 27.90, 'Gin Mare è un gin premium spagnolo che cattura l''essenza del Mediterraneo.', 3, 'Woodford Reserve', 0, 3, 'https://www.superbar.it/958-thickbox_default/woodford-reserve-kentucky-straight-bourbon-whiskey.jpg', 7);
